...
const DegreeOverlay = ({ studentRecord, canvasWidth, canvasHeight }) => {
  ...
  const draw = (ctx) => {
    ...
    img.onload = () => {
      ...
      ctx.font = 'normal 600 70px Goteborg, regular';
      ...
      ctx.fillText(studentRecord.name, gridToCanvasX(12.8), gridToCanvasY(9.1)); // Name at (12,9)
      ctx.fillText(studentRecord.graduation_date, gridToCanvasX(8.5) , gridToCanvasY(13.7)); // Example positions
      ctx.fillText(studentRecord.graduation_month, gridToCanvasX(13.5), gridToCanvasY(13.7));
      ctx.fillText(studentRecord.graduation_year, gridToCanvasX(21.5), gridToCanvasY(13.7));
    };
